        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-7 text-end">
                    <div class="row">
                        <div class="col-3 col-sm-6 col-md-3 offset-md-4 col-lg-3 offset-lg-5 col-xl-2 offset-xl-7 col-xxl-2 offset-xxl-6 my-auto text-end">
                            <p
                                class="mb-0"
                                data-aos="fade-up"
                                data-aos-delay="750"
                        ...
                        <div class="col-9 col-sm-6 col-md-5 col-lg-4 col-xl-3 col-xxl-3 my-auto">
    ...
    <script src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/js/53ca2f98080d95f6ffab.app.bundle.js"></script>
