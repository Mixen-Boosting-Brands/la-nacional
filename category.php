                                ...
                                <div class="col-sm-6 col-md-4 col-lg-3 mb-4">
                                    ...
                                    <?php if( have_rows('detalles_del_producto') ): while( have_rows('detalles_del_producto') ): the_row(); ?>
                                        ...
                                        <div class="card-img-top">
                                            <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#modal" data-bs-titulo="<?php the_title(); ?>" data-bs-thumbnail-url="<?php echo get_the_post_thumbnail_url(get_the_ID(),'full'); ?>" data-bs-gramaje="<?php $gramajes = get_sub_field('peso_del_producto')['gramaje']; if( $gramajes ): ?><ul><?php foreach( $gramajes as $gramaje ): ?><li><?php echo $gramaje; ?></li><?php endforeach; ?></ul><?php endif; ?>" data-bs-ingredientes="<?php if( get_sub_field('ingredientes_del_producto') ): ?><?php echo get_sub_field('ingredientes_del_producto')['ingredientes']; ?><?php endif; ?>">
